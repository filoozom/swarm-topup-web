...
const TopUp = () => {
  ...
  return (
    <>
      ...
      <p>
        The Hacker Manifesto has been uploaded to the Swarm network using postage stamp batch id{" "}
        <em>
        ...
        <a href="https://ethswarm.org">https://ethswarm.org</a>, or view it using
        the <em>bzz.link</em> service at{" "}
      ...
      <h2>Stamp Status</h2>
      <p>
        The Hacker Manifesto Stamp will expire someday unless it is topped up.{/*in XXX Seconds (xxx days)*/} Like minded individuals are encouraged to contribute BZZ to the Hacker
      ...
      <p>
        ...
        the Gnosis Chain network. BZZ can be acquired by sending ETH to the Bonding Curve contract which can be found at address <em>0x4f32ab778e85c4ad0cead54f8f82f5ee74d46904</em> on the Ethereum network.
      </p>
      <p>
        For your convenience, a tool is provided below which can be used
